                        ...
                        <div class="tab-pane fade show active" id="launchdinner" role="tabpanel" aria-labelledby="pills-home-tab">
                            <div class="menu-item">
                                <div class="item-wrapper">
                                    ...
                                    <span class="item-price">205,000 تومان</span>
                                    <!-- section title end -->
                                </div>
                                <!-- divider start -->
                            ...
                            <div class="menu-item">
                                <div class="item-wrapper">
                                    ...
                                    <span class="item-divider"></span>
                                    <span class="item-price">195,000 تومان</span>
                                    <!-- section title end -->
                                </div>
                                <!-- divider start -->
                                <div class="divider-m"></div>
                            ...
                            <div class="menu-item">
                                <div class="item-wrapper">
                                    ...
                                    <span class="item-divider"></span>
                                    <span class="item-price">208,000 تومان</span>
                                    <!-- section title end -->
                                </div>
                                <!-- divider start -->
                                <div class="divider-m"></div>
                            ...
                            <div class="menu-item">
                                <div class="item-wrapper">
                                    ...
                                    <span class="item-divider"></span>
                                    <span class="item-price">145,000 تومان</span>
                                    <!-- section title end -->
                                </div>
                                <!-- divider start -->
                                <div class="divider-m"></div>
                            ...
                            <div class="menu-item">
                                <div class="item-wrapper">
                                    ...
                                    <span class="item-divider"></span>
                                    <span class="item-price">153,000 تومان</span>
                                    <!-- section title end -->
                                </div>
                                <!-- divider start -->
                                <div class="divider-m"></div>
                            ...
                            <div class="menu-item">
                                <div class="item-wrapper">
                                    ...
                                    <span class="item-divider"></span>
                                    <span class="item-price">93,000 تومان</span>
                                    <!-- section title end -->
                                </div>
                                <!-- divider start -->
                                <div class="divider-m"></div>
                            ...
                            <div class="menu-item">
                                <div class="item-wrapper">
                                    ...
                                    <span class="item-divider"></span>
                                    <span class="item-price">158,000 تومان</span>
                                    <!-- section title end -->
                                </div>
                                <!-- divider start -->
                                <div class="divider-m"></div>
                            ...
                            <div class="menu-item">
                                <div class="item-wrapper">
                                    ...
                                    <span class="item-divider"></span>
                                    <span class="item-price">98,000 تومان</span>
                                    <!-- section title end -->
                                </div>
                                <!-- divider start -->
                                <div class="divider-m"></div>
                            ...
                            <div class="menu-item">
                                <div class="item-wrapper">
                                    ...
                                    <h3>چلو قیمه نثار</h3>
                                    <span class="item-divider"></span>
                                    <span class="item-price">248,000 تومان</span>
                                    <!-- section title end -->
                                </div>
                                <!-- divider start -->
                                <div class="divider-m"></div>
                            ...
                            <div class="menu-item">
                                <div class="item-wrapper">
                                    ...
                                    <span class="item-divider"></span>
                                    <span class="item-price">148,000 تومان</span>
                                    <!-- section title end -->
                                </div>
                                <!-- divider start -->
                                <div class="divider-m"></div>
                            ...
                            <div class="menu-item">
                                <div class="item-wrapper">
                                    ...
                                    <div class="menu-img">
                                        <div class="menu-img-inner">
                                            <img src="/src/images/foods/gheime-tahchin.png" alt="Img">
                                        </div>
                                    </div>
                                    <!-- items img end -->
                                    <!-- section title start -->
                            ...
                            <div class="menu-item">
                                <div class="item-wrapper">
                                    ...
                                    <h3>تهچین ساده</h3>
                                    <span class="item-divider"></span>
                                    <span class="item-price">60,000 تومان</span>
                                    <!-- section title end -->
                                </div>
                                <!-- divider start -->
                                <div class="divider-m"></div>
                            ...
                            <div class="menu-item">
                                <div class="item-wrapper">
                                    ...
                                    <span class="item-divider"></span>
                                    <span class="item-price">155,000 تومان</span>
                                    <!-- section title end -->
                                </div>
                                <!-- divider start -->
                                <div class="divider-m"></div>
                            ...
                            <div class="menu-item">
                                <div class="item-wrapper">
                                    ...
                                    <span class="item-divider"></span>
                                    <span class="item-price">79,000 تومان</span>
                                    <!-- section title end -->
                                </div>
                                <!-- divider start -->
                                <div class="divider-m"></div>
                            ...
                            <div class="menu-item">
                                <div class="item-wrapper">
                                    ...
                                    <h3>کشک و بادمجان</h3>
                                    <span class="item-divider"></span>
                                    <span class="item-price">95,000 تومان</span>
                                    <!-- section title end -->
                                </div>
                                <!-- divider start -->
                                <div class="divider-m"></div>
                            ...
                            <div class="menu-item">
                                <div class="item-wrapper">
                                    ...
                                    <h3>میرزاقاسمی</h3>
                                    <span class="item-divider"></span>
                                    <span class="item-price">110,000 تومان</span>
                                    <!-- section title end -->
                                </div>
                                <!-- divider start -->
                                <div class="divider-m"></div>
                            ...
                            <div class="menu-item">
                                <div class="item-wrapper">
                                    ...
                                    <h3>شامی پوک</h3>
                                    <span class="item-divider"></span>
                                    <span class="item-price">115,000 تومان</span>
                                    <!-- section title end -->
                                </div>
                                <!-- divider start -->
                                <div class="divider-m"></div>
                        ...
                        <div class="tab-pane fade" id="starter" role="tabpanel" aria-labelledby="pills-profile-tab">
                            <div class="menu-item">
                                <div class="item-wrapper">
                                    ...
                                    <span class="item-divider"></span>
                                    <span class="item-price">38,000 تومان</span>
                                    <!-- section title end -->
                                </div>
                                <!-- divider start -->
                                <div class="divider-m"></div>
                            ...
                            <div class="menu-item">
                                <div class="item-wrapper">
                                    ...
                                    <h3>ماست سنتی</h3>
                                    <span class="item-divider"></span>
                                    <span class="item-price">28,000 تومان</span>
                                    <!-- section title end -->
                                </div>
                                <!-- divider start -->
                                <div class="divider-m"></div>
                            ...
                            <div class="menu-item">
                                <div class="item-wrapper">
                                    ...
                                    <h3>ماست شرکتی</h3>
                                    <span class="item-divider"></span>
                                    <span class="item-price">8,000 تومان</span>
                                    <!-- section title end -->
                                </div>
                                <!-- divider start -->
                                <div class="divider-m"></div>
                            ...
                            <div class="menu-item">
                                <div class="item-wrapper">
                                    ...
                                    <h3>زیتون ساده</h3>
                                    <span class="item-divider"></span>
                                    <span class="item-price">30,000 تومان</span>
                                    <!-- section title end -->
                                </div>
                                <!-- divider start -->
                                <div class="divider-m"></div>
                            ...
                            <div class="menu-item">
                                <div class="item-wrapper">
                                    ...
                                    <h3>سبزی خوردن</h3>
                                    <span class="item-divider"></span>
                                    <span class="item-price">10,000 تومان</span>
                                    <!-- section title end -->
                                </div>
                                <!-- divider start -->
                                <div class="divider-m"></div>
                            ...
                            <div class="menu-item">
                                <div class="item-wrapper">
                                    ...
                                    <h3>سالاد شیرازی</h3>
                                    <span class="item-divider"></span>
                                    <span class="item-price">18,000 تومان</span>
                                    <!-- section title end -->
                                </div>
                                <!-- divider start -->
                                <div class="divider-m"></div>
                        ...
                        <div class="tab-pane fade" id="drinks" role="tabpanel" aria-labelledby="pills-contact-tab">
                            ...
                            <div class="menu-item">
                                <div class="item-wrapper">
                                    ...
                                    <h3>شربت لیمو</h3>
                                    <span class="item-divider"></span>
                                    <span class="item-price">33,000 تومان</span>
                                    <!-- section title end -->
                                </div>
                                <!-- divider start -->
                                <div class="divider-m"></div>
                            ...
                            <div class="menu-item">
                                <div class="item-wrapper">
                                    ...
                                    <h3>دوغ سنتی</h3>
                                    <span class="item-divider"></span>
                                    <span class="item-price">20,000 تومان</span>
                                    <!-- section title end -->
                                </div>
                                <!-- divider start -->
                                <div class="divider-m"></div>
                            ...
                            <div class="menu-item">
                                <div class="item-wrapper">
                                    ...
                                    <h3>نوشابه قوطی</h3>
                                    <span class="item-divider"></span>
                                    <span class="item-price">12,000 تومان</span>
                                    <!-- section title end -->
                                </div>
                                <!-- divider start -->
                                <div class="divider-m"></div>
                            ...
                            <div class="menu-item">
                                <div class="item-wrapper">
                                    ...
                                    <h3>نوشابه زیرو</h3>
                                    <span class="item-divider"></span>
                                    <span class="item-price">11,000 تومان</span>
                                    <!-- section title end -->
                                </div>
                                <!-- divider start -->
                                <div class="divider-m"></div>
                            ...
                            <div class="menu-item">
                                <div class="item-wrapper">
                                    ...
                                    <h3>آب معدنی</h3>
                                    <span class="item-divider"></span>
                                    <span class="item-price">5,000 تومان</span>
                                    <!-- section title end -->
                                </div>
                                <!-- divider start -->
                                <div class="divider-m"></div>
